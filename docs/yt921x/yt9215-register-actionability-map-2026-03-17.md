...
| `0x300200/0x300280/0x300400`, `0x341000..0x343000`, `0x34c000..0x357000` (stock QoS schedule/shaper tables) | Stock reverse + symbol-field decode now provides concrete table/field layouts (`docs/yt921x/live/yt_stock_qos_field_decode_2026-03-30.tsv`, `docs/yt921x/live/yt_stock_qos_driver_map_2026-03-30.md`). Runtime behavior for scheduler-policy bits is not fully A/B validated yet. |
