...
#define  YT921X_PSCH_SHP_DUAL_RATE		BIT(3)
#define  YT921X_PSCH_SHP_METER_ID_M		GENMASK(2, 0)
#define   YT921X_PSCH_SHP_METER_ID(x)			FIELD_PREP(YT921X_PSCH_SHP_METER_ID_M, (x))
...
#define  YT921X_QSCH_SHP_METER_ID_M		GENMASK(2, 0)
#define   YT921X_QSCH_SHP_METER_ID(x)			FIELD_PREP(YT921X_QSCH_SHP_METER_ID_M, (x))
#define  YT921X_QSCH_SHP_MODE			BIT(3)
#define  YT921X_QSCH_SHP_COUPLE			BIT(4)
#define  YT921X_QSCH_SHP_DUAL_RATE		BIT(5)
#define  YT921X_QSCH_SHP_EN			BIT(6)
 ...
 */
#define YT921X_STOCK_LOOP_DETECT_TOP_CTRL	0x080230
#define  YT921X_STOCK_LOOP_DETECT_F0_M		GENMASK(27, 26)
#define  YT921X_STOCK_LOOP_DETECT_F1		BIT(25)
#define  YT921X_STOCK_LOOP_DETECT_UNIT_ID2_M	GENMASK(24, 23)	/* field2 */
#define  YT921X_STOCK_LOOP_DETECT_UNIT_ID1_M	GENMASK(22, 21)	/* field3 */
#define  YT921X_STOCK_LOOP_DETECT_UNIT_ID0_M	GENMASK(20, 19)	/* field4 */
#define  YT921X_STOCK_LOOP_DETECT_EN		BIT(18)		/* field5 */
#define  YT921X_STOCK_LOOP_DETECT_TPID_M	GENMASK(17, 2)	/* field6 */
#define  YT921X_STOCK_LOOP_DETECT_F7		BIT(1)
#define  YT921X_STOCK_LOOP_DETECT_GEN_WAY	BIT(0)		/* field8 */

#define YT921X_STOCK_STORM_RATE_IO		0x220100
#define  YT921X_STOCK_STORM_RATE_IO_TIMESLOT_M	GENMASK(11, 0)
#define YT921X_STOCK_STORM_MC_TYPE_CTRL	0x220140
#define  YT921X_STOCK_STORM_MC_TYPE_CTRL_PORTS_M	GENMASK(10, 0)
#define   YT921X_STOCK_STORM_MC_TYPE_CTRL_PORTS(x) \
		FIELD_PREP(YT921X_STOCK_STORM_MC_TYPE_CTRL_PORTS_M, (x))
#define YT921X_STOCK_STORM_CONFIG		0x220200
#define  YT921X_STOCK_STORM_CONFIG_RATE_F0_M	GENMASK(31, 13)
#define   YT921X_STOCK_STORM_CONFIG_RATE_F0(x) \
		FIELD_PREP(YT921X_STOCK_STORM_CONFIG_RATE_F0_M, (x))
#define  YT921X_STOCK_STORM_CONFIG_RATE_F1_M	GENMASK(12, 3)
#define   YT921X_STOCK_STORM_CONFIG_RATE_F1(x) \
		FIELD_PREP(YT921X_STOCK_STORM_CONFIG_RATE_F1_M, (x))
#define  YT921X_STOCK_STORM_CONFIG_INCLUDE_GAP	BIT(2)
#define  YT921X_STOCK_STORM_CONFIG_MODE		BIT(1)
#define  YT921X_STOCK_STORM_CONFIG_EN		BIT(0)

/* Stock table-id 0xa3 (RMA control), reverse-mapped from yt_switch.ko.
 * Kept for header parity; not wired into active DSA path yet.
 */
#define YT921X_STOCK_RMA_CTRLn(n)		(0x1805d0 + 4 * (n))
#define  YT921X_STOCK_RMA_CTRL_F0		BIT(12)
#define  YT921X_STOCK_RMA_CTRL_F1		BIT(11)
#define  YT921X_STOCK_RMA_CTRL_F2		BIT(10)
#define  YT921X_STOCK_RMA_CTRL_F3		BIT(9)		/* action bit 1 (field3) */
#define  YT921X_STOCK_RMA_CTRL_F4		BIT(8)		/* action bit 0 (field4) */
#define  YT921X_STOCK_RMA_CTRL_F5		BIT(7)		/* bypass vlan filter (field5) */
#define  YT921X_STOCK_RMA_CTRL_F6		BIT(6)		/* bypass port isolation (field6) */
#define  YT921X_STOCK_RMA_CTRL_FWD_MASK_M	GENMASK(5, 0)	/* forward/copy portmask (field7) */
#define   YT921X_STOCK_RMA_CTRL_FWD_MASK_ALL	YT921X_STOCK_RMA_CTRL_FWD_MASK_M
 ...
 */
#define YT921X_STOCK_VLAN_IGR_TRANS_CTRL	0x2100e0	/* tbl 0x20 */
#define YT921X_STOCK_CTRLPKT_ARP_ACT		0x180284	/* tbl 0x74 */
#define YT921X_STOCK_CTRLPKT_ND_ACT		0x180288	/* tbl 0x75 */
#define YT921X_STOCK_CTRLPKT_LLDP_EEE_ACT	0x18028c	/* tbl 0x76 */
#define YT921X_STOCK_CTRLPKT_LLDP_ACT		0x180290	/* tbl 0x77 */

#define YT921X_STOCK_VLAN_TRANS_UNTAG_PVID_IGNORE	0x230108	/* tbl 0x2f */
#define YT921X_STOCK_VLAN_TRANS_RANGE_PROFILE		0x230200	/* tbl 0x30 */
#define YT921X_STOCK_VLAN_IGR_TRANS_TABLE0		0x230400	/* tbl 0x32 */
#define YT921X_STOCK_VLAN_IGR_TRANS_TABLE1		0x230600	/* tbl 0x33 */

#define YT921X_STOCK_L2_PORT_LEARNLIMIT_CNT		0x180404	/* tbl 0x7f */
#define YT921X_STOCK_L2_SYSTEM_LEARNLIMIT		0x180438	/* tbl 0x80 */
#define YT921X_STOCK_L2_FDB_UCAST_CNT		0x18043c	/* tbl 0x81 */
#define YT921X_STOCK_L2_FDB_AGING_PORT_EN		0x180448	/* tbl 0x83 */
#define YT921X_STOCK_MCAST_STATIC_ROUTER_PORT	0x180468	/* tbl 0x89 */
#define YT921X_STOCK_MCAST_DYNAMIC_ROUTER_PORT	0x18046c	/* tbl 0x8a */
#define YT921X_STOCK_MCAST_ROUTER_PORT_AGE_A	0x180474	/* tbl 0x8c */
#define YT921X_STOCK_MCAST_ROUTER_PORT_AGE_B	0x180478	/* tbl 0x8d */
#define YT921X_STOCK_MCAST_FWD_POLICY		0x18047c	/* tbl 0x8e */
#define YT921X_STOCK_MCAST_PORT_POLICY		0x180480	/* tbl 0x8f */
#define YT921X_STOCK_MCAST_DYNAMIC_ROUTER_PORT_STAT	0x1804bc	/* tbl 0x93 */
#define YT921X_STOCK_MCAST_LEARNLIMIT		0x180500	/* tbl 0x96 */
#define YT921X_STOCK_L2_FDB_MCAST_CNT		0x180504	/* tbl 0x97 */
#define YT921X_STOCK_MCAST_IPMC_BYPASS_ISO	0x1805a4	/* tbl 0xa0 */
#define YT921X_STOCK_DOT1X_PORT_BASED		0x18059c	/* tbl 0x9e */
#define YT921X_STOCK_DOT1X_BYPASS_CTRL		0x1805a0	/* tbl 0x9f */
#define YT921X_STOCK_DOT1X_PORT_BASEDn(n)	(YT921X_STOCK_DOT1X_PORT_BASED + 4 * (n))
#define YT921X_STOCK_DOT1X_BYPASS_CTRLn(n)	(YT921X_STOCK_DOT1X_BYPASS_CTRL + 4 * (n))
#define YT921X_STOCK_MCAST_ROUTER_PORT_AGE_C	0x1806bc	/* tbl 0xaa */
#define YT921X_STOCK_MCAST_VLAN_TABLE		0x180700	/* tbl 0xab */
#define  YT921X_STOCK_MCAST_STATIC_ROUTER_PORT_M	GENMASK(10, 0)	/* 0x89 field0 */
#define  YT921X_STOCK_MCAST_DYNAMIC_ROUTER_PORT_ALLOW_M	GENMASK(14, 4)	/* 0x8a field0 */
#define   YT921X_STOCK_MCAST_DYNAMIC_ROUTER_PORT_ALLOW(x) \
		FIELD_PREP(YT921X_STOCK_MCAST_DYNAMIC_ROUTER_PORT_ALLOW_M, (x))
#define  YT921X_STOCK_MCAST_FWD_POLICY_FAST_LEAVE	BIT(4)		/* 0x8e field5 */
#define  YT921X_STOCK_MCAST_PORT_POLICY_LEAVE_ALLOW	BIT(4)		/* 0x8f field3 */
#define  YT921X_STOCK_MCAST_PORT_POLICY_REPORT_ALLOW	BIT(3)		/* 0x8f field4 */
#define  YT921X_STOCK_MCAST_PORT_POLICY_QUERY_ALLOW	BIT(2)		/* 0x8f field5 */
#define  YT921X_STOCK_MCAST_PORT_POLICY_IGMP_BYPASS_ISO	BIT(0)		/* 0x8f field7 */
#define YT921X_STOCK_LAG_LEARNLIMIT		0x180808	/* tbl 0xaf */
#define YT921X_STOCK_ACL_RULE_CTRL		0x201000	/* tbl 0x34 */
#define YT921X_STOCK_ACL_PORT_CTRL		0x202000	/* tbl 0x35 */
#define YT921X_STOCK_ACL_BLOCK_CTRL		0x202004	/* tbl 0x36 */
#define YT921X_STOCK_ACL_RULE_DATA		0x203000	/* tbl 0x37 */
#define YT921X_STOCK_ACL_UNMATCH_PERMIT	0x1806a0	/* tbl 0xa5 */

#define YT921X_STOCK_RATE_IGR_BW_CTRL		0x220104	/* tbl 0xc7 */
#define  YT921X_STOCK_RATE_IGR_BW_CTRL_TIMESLOT_M	GENMASK(11, 0)	/* field0 */
#define YT921X_STOCK_RATE_IGR_BW_ENABLE		0x220108	/* tbl 0xc8 */
#define  YT921X_STOCK_RATE_IGR_BW_ENABLE_EN		BIT(4)		/* field0 */
#define  YT921X_STOCK_RATE_IGR_BW_ENABLE_METER_ID_M	GENMASK(3, 0)	/* field1 */
#define   YT921X_STOCK_RATE_IGR_BW_ENABLE_METER_ID(x) \
		FIELD_PREP(YT921X_STOCK_RATE_IGR_BW_ENABLE_METER_ID_M, (x))
#define YT921X_STOCK_RATE_METER_CONFIG		0x220800	/* tbl 0xce */
#define YT921X_STOCK_RATE_METER_CONFIGn(n) \
	(YT921X_STOCK_RATE_METER_CONFIG + YT921X_STOCK_RATE_METER_STRIDE * (n))
#define YT921X_STOCK_RATE_METER_CONFIG_WORD1(n) \
	(YT921X_STOCK_RATE_METER_CONFIGn(n) + 0x4)
#define YT921X_STOCK_RATE_METER_CONFIG_WORD2(n) \
	(YT921X_STOCK_RATE_METER_CONFIGn(n) + 0x8)

/* tbl 0xce selected fields used by stock ingress-meter path */
#define  YT921X_STOCK_RATE_METER_CFG_TOKEN_UNIT_M	GENMASK(1, 0)	/* field11, word1 */
#define   YT921X_STOCK_RATE_METER_CFG_TOKEN_UNIT(x) \
		FIELD_PREP(YT921X_STOCK_RATE_METER_CFG_TOKEN_UNIT_M, (x))
#define  YT921X_STOCK_RATE_METER_CFG_CIR_M		GENMASK(19, 2)	/* field10, word1 */
#define   YT921X_STOCK_RATE_METER_CFG_CIR(x) \
		FIELD_PREP(YT921X_STOCK_RATE_METER_CFG_CIR_M, (x))
#define  YT921X_STOCK_RATE_METER_CFG_CBS_M		GENMASK(31, 20)	/* field9, word1 */
#define   YT921X_STOCK_RATE_METER_CFG_CBS(x) \
		FIELD_PREP(YT921X_STOCK_RATE_METER_CFG_CBS_M, (x))
#define  YT921X_STOCK_RATE_METER_CFG_F4_M		GENMASK(9, 7)	/* field4, word2 */
#define   YT921X_STOCK_RATE_METER_CFG_F4(x) \
		FIELD_PREP(YT921X_STOCK_RATE_METER_CFG_F4_M, (x))
#define  YT921X_STOCK_RATE_METER_CFG_F6		BIT(5)		/* field6, word2 */

#define YT921X_STOCK_QOS_QUEUE_MAP_UCAST	0x300200	/* tbl 0xd3 */
#define YT921X_STOCK_QOS_QUEUE_MAP_MCAST	0x300280	/* tbl 0xd4 */
#define YT921X_STOCK_QOS_QUEUE_MAP_UCASTn(port) \
	(YT921X_STOCK_QOS_QUEUE_MAP_UCAST + 4 * (port))
#define YT921X_STOCK_QOS_QUEUE_MAP_MCASTn(port) \
	(YT921X_STOCK_QOS_QUEUE_MAP_MCAST + 4 * (port))
#define  YT921X_STOCK_QOS_UCAST_QMAP_PRIO_SHIFT(prio)	(28 - 4 * (prio))
#define  YT921X_STOCK_QOS_UCAST_QMAP_PRIO_M(prio) \
		(GENMASK(2, 0) << YT921X_STOCK_QOS_UCAST_QMAP_PRIO_SHIFT(prio))
#define  YT921X_STOCK_QOS_UCAST_QMAP_PRIO(prio, qid) \
		(((u32)(qid) & GENMASK(2, 0)) << \
		 YT921X_STOCK_QOS_UCAST_QMAP_PRIO_SHIFT(prio))
#define  YT921X_STOCK_QOS_MCAST_QMAP_PRIO_SHIFT(prio)	(14 - 2 * (prio))
#define  YT921X_STOCK_QOS_MCAST_QMAP_PRIO_M(prio) \
		(GENMASK(1, 0) << YT921X_STOCK_QOS_MCAST_QMAP_PRIO_SHIFT(prio))
#define  YT921X_STOCK_QOS_MCAST_QMAP_PRIO(prio, qid) \
		(((u32)(qid) & GENMASK(1, 0)) << \
		 YT921X_STOCK_QOS_MCAST_QMAP_PRIO_SHIFT(prio))
#define YT921X_STOCK_MIRROR_PRIO_MAP		0x300304	/* tbl 0xd6 */
#define  YT921X_STOCK_MIRROR_PRIO_MAP_IGR_EN	BIT(7)		/* field0 */
#define  YT921X_STOCK_MIRROR_PRIO_MAP_IGR_PRIO_M	GENMASK(6, 4)	/* field1 */
#define   YT921X_STOCK_MIRROR_PRIO_MAP_IGR_PRIO(x) \
		FIELD_PREP(YT921X_STOCK_MIRROR_PRIO_MAP_IGR_PRIO_M, (x))
#define  YT921X_STOCK_MIRROR_PRIO_MAP_EGR_EN	BIT(3)		/* field2 */
#define  YT921X_STOCK_MIRROR_PRIO_MAP_EGR_PRIO_M	GENMASK(2, 0)	/* field3 */
#define   YT921X_STOCK_MIRROR_PRIO_MAP_EGR_PRIO(x) \
		FIELD_PREP(YT921X_STOCK_MIRROR_PRIO_MAP_EGR_PRIO_M, (x))
#define  YT921X_STOCK_MIRROR_PRIO_MAP_DEFAULT_PRIO	0
#define YT921X_STOCK_QOS_SCHED_SP		0x300400	/* tbl 0xd7 */
#define YT921X_STOCK_QOS_SCHED_SPn(port) \
	(YT921X_STOCK_QOS_SCHED_SP + 4 * (port))
#define  YT921X_STOCK_QOS_SCHED_SP_MASK		GENMASK(7, 0)

#define YT921X_STOCK_QOS_REMARK_PORT_CTRL	0x100000	/* tbl 0xd9 */
#define YT921X_STOCK_QOS_REMARK_PORT_CTRLn(port) \
	(YT921X_STOCK_QOS_REMARK_PORT_CTRL + 4 * (port))
#define  YT921X_STOCK_QOS_REMARK_PORT_CPRI_EN	BIT(1)		/* field7 */
#define  YT921X_STOCK_QOS_REMARK_PORT_SPRI_EN	BIT(0)		/* field8 */

#define YT921X_STOCK_QOS_REMARK_PORT		0x100080	/* tbl 0xda */
#define YT921X_STOCK_QOS_REMARK_DSCP		0x100100	/* tbl 0xdb */
#define YT921X_STOCK_QOS_REMARK_DSCPn(idx) \
	(YT921X_STOCK_QOS_REMARK_DSCP + 4 * (idx))
#define  YT921X_STOCK_QOS_REMARK_DSCP_VAL_M	GENMASK(5, 0)	/* egr_dscp_remarknm_field */
#define   YT921X_STOCK_QOS_REMARK_DSCP_VAL(x) \
		FIELD_PREP(YT921X_STOCK_QOS_REMARK_DSCP_VAL_M, (x))

#define YT921X_STOCK_QOS_REMARK_CPRI_SPRI	0x100200	/* tbl 0xdc */
#define YT921X_STOCK_QOS_REMARK_PRIOn(idx) \
	(YT921X_STOCK_QOS_REMARK_CPRI_SPRI + 4 * (idx))
#define  YT921X_STOCK_QOS_REMARK_PRIO_VAL_M	GENMASK(3, 1)	/* egr_prio_remarknm_field field0 */
#define   YT921X_STOCK_QOS_REMARK_PRIO_VAL(x) \
		FIELD_PREP(YT921X_STOCK_QOS_REMARK_PRIO_VAL_M, (x))
#define  YT921X_STOCK_QOS_REMARK_PRIO_EN	BIT(0)		/* egr_prio_remarknm_field field1 */
#define YT921X_STOCK_VLAN_EGR_TRANS_TABLE0	0x100320	/* tbl 0xde */
#define YT921X_STOCK_VLAN_EGR_TRANS_TABLE1	0x1003a0	/* tbl 0xdf */
#define YT921X_STOCK_VLAN_EGR_TRANS_TABLE2	0x100420	/* tbl 0xe0 */
#define YT921X_STOCK_VLAN_EGR_TRANSPARENT	0x1004a8	/* tbl 0xe1 */

#define YT921X_STOCK_QOS_SCHED_DWRR		0x341000	/* tbl 0xe6 */
#define YT921X_STOCK_QOS_SCHED_DWRR_MODE0	0x342000	/* tbl 0xe7 */
#define YT921X_STOCK_QOS_SCHED_DWRR_MODE1	0x343000	/* tbl 0xe8 */
 ...
 */
#define YT921X_STOCK_QOS_SCHED_PORTS		11U
#define YT921X_STOCK_QOS_SCHED_UCAST_FLOWS	8U
#define YT921X_STOCK_QOS_SCHED_MCAST_FLOWS	4U
#define YT921X_STOCK_QOS_SCHED_FLOWS_PER_PORT \
		(YT921X_STOCK_QOS_SCHED_UCAST_FLOWS + YT921X_STOCK_QOS_SCHED_MCAST_FLOWS)
#define YT921X_STOCK_QOS_SCHED_FLOW_INDEX(port, qid, is_mcast) \
		((port) * YT921X_STOCK_QOS_SCHED_FLOWS_PER_PORT + \
		 ((is_mcast) ? (YT921X_STOCK_QOS_SCHED_UCAST_FLOWS + (qid)) : (qid)))
#define YT921X_STOCK_QOS_SCHED_DWRRn(idx) \
		(YT921X_STOCK_QOS_SCHED_DWRR + 4 * (idx))
#define YT921X_STOCK_QOS_SCHED_DWRR_MODE0n(idx) \
		(YT921X_STOCK_QOS_SCHED_DWRR_MODE0 + 4 * (idx))
#define YT921X_STOCK_QOS_SCHED_DWRR_MODE1n(idx) \
		(YT921X_STOCK_QOS_SCHED_DWRR_MODE1 + 4 * (idx))
/* qsch_flow_map_tblm_field (tbl 0xe6) */
#define  YT921X_STOCK_QOS_SCHED_FLOW_F0_M	GENMASK(27, 18)
#define  YT921X_STOCK_QOS_SCHED_FLOW_F1_M	GENMASK(17, 8)
#define  YT921X_STOCK_QOS_SCHED_FLOW_F2_M	GENMASK(7, 4)
#define  YT921X_STOCK_QOS_SCHED_FLOW_F3_M	GENMASK(3, 0)
#define  YT921X_STOCK_QOS_SCHED_FLOW_F0(x) \
		FIELD_PREP(YT921X_STOCK_QOS_SCHED_FLOW_F0_M, (x))
#define  YT921X_STOCK_QOS_SCHED_FLOW_F1(x) \
		FIELD_PREP(YT921X_STOCK_QOS_SCHED_FLOW_F1_M, (x))
/* qsch_e_dwrr_cfg_tblm_field / qsch_c_dwrr_cfg_tblm_field (tbl 0xe7/0xe8) */
#define  YT921X_STOCK_QOS_SCHED_DWRR_CFG_EN	BIT(0)
...
#define   YT921X_STP_PORTn_DISABLED(port)		YT921X_STP_PORTn(port, 3)
#define   YT921X_STP_PORTn_LEARNING(port)		YT921X_STP_PORTn(port, 1)
#define   YT921X_STP_PORTn_BLOCKING(port)		YT921X_STP_PORTn(port, 3)
#define   YT921X_STP_PORTn_FORWARD(port)		YT921X_STP_PORTn(port, 0)
